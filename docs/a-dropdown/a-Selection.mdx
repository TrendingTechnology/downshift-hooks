...
The `useDownshiftSelection` hook provides functionality and accessibility to a dropdown, as described by the corresponding [ARIA docs](https://www.w3.org/TR/wai-aria-practices/examples/listbox/listbox-collapsible.html).
